...
export const StaffDashboard = () => {
  ...
  const fetchPatients = async () => {
    try {
      const response = await axios.get("https://cams-qgq9.onrender.com/api/v1/patient/getAllPatient");
  ...
  const fetchDoctors = async () => {
    try {
      const response = await axios.get("https://cams-qgq9.onrender.com/api/v1/doctor/getAllDoctors");
