...
export const DoctorManagement = () => {
  ...
  const fetchDoctors = async () => {
    try {
      const response = await fetch("https://cams-b7fw.onrender.com/api/v1/doctor/getAllDoctors");
  ...
  const handleAddDoctor = async (values) => {
    try {
      ...
      const response = await fetch("https://cams-b7fw.onrender.com/api/v1/doctor/addNewDoctor", {
        method: "POST",
  ...
  const handleDeleteDoctor = async (doctorId) => {
    try {
      const response = await fetch(`https://cams-b7fw.onrender.com/api/v1/doctor/deleteDoctor/${doctorId}`, {
        method: "DELETE",
      });
