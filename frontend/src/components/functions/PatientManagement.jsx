...
export const PatientManagement = () => {
  ...
  const fetchPatients = async () => {
    try {
      const response = await fetch("https://cams-b7fw.onrender.com/api/v1/patient/getAllPatient");
  ...
  const handleAddPatient = async (values) => {
    try {
      const response = await fetch("https://cams-b7fw.onrender.com/api/v1/patient/addNewPatient", {
        method: "POST",
  ...
  const handleDeletePatient = async (patientId) => {
    try {
      const response = await fetch(
        `https://cams-b7fw.onrender.com/api/v1/patient/deletePatient/${patientId}`,
        { method: "DELETE" }
      );
